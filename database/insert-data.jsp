...
INSERT INTO `user` ( `name`, `password`, `fullname`, `status`, `roleid`) VALUES ( 'admin', '1', 'Trieu Ngo Quang', '1', '1');
INSERT INTO `user` ( `name`, `password`, `fullname`, `status`, `roleid`) VALUES ( 'user', '1', 'Trieu Ngo Quang', '1', '2');